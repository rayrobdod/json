...
/**
 * A {@link JSONParseListener} that removes the whitespace from a sequence representing a JSONString
 * 
 ...
 * @deprecated - replaced by {@link com.rayrobdod.javaScriptObjectNotation.parser.listeners.Minifier}
 */
public class CondenserJSONListener implements JSONParseListener
{
	...
	private CondenserJSONListener pipedL;
	
	/**
	 * Creates a JSONParseListener that does stuff.
	 */
	public CondenserJSONListener()
	{
			...
			// if nothing has been put into the builder yet
		{
			if (character == '[' || character == '{')
			{
				try
				{
					...
					pipedL = new CondenserJSONListener();
	...
	private class PipedRunnable implements Runnable
	{
		...
		private final CondenserJSONListener l;
		
		public PipedRunnable(CondenserJSONListener l, PipedReader reader)
		{
			this.reader = reader;
			this.l = l;
		}
